...
(declare-fun successors_of_1 () Int)
(assert (>= successors_of_1 0))
(assert (<= successors_of_1 7))
(declare-fun successors_of_2 () Int)
(assert (>= successors_of_2 0))
(assert (<= successors_of_2 7))
(declare-fun successors_of_3 () Int)
(assert (>= successors_of_3 0))
(assert (<= successors_of_3 7))
(declare-fun successors_of_4 () Int)
(assert (>= successors_of_4 0))
(assert (<= successors_of_4 7))
(declare-fun successors_of_5 () Int)
(assert (>= successors_of_5 0))
(assert (<= successors_of_5 7))
(declare-fun successors_of_6 () Int)
(assert (>= successors_of_6 0))
(assert (<= successors_of_6 7))
...
(assert (<= distance_1_traveled 8))
(assert (<= distance_2_traveled 8))
(check-sat)
(get-model)