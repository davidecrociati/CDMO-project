...
(assert (>= stop_2_2 1))
(assert (<= stop_2_2 6))
(assert (=> (> courier_1_capa courier_2_capa) (> load_1 load_2)))(assert (=> (<= 1 (+ (ite (= item_1_resp 1) 1 0) (ite (= item_2_resp 1) 1 0) (ite (= item_3_resp 1) 1 0) (ite (= item_4_resp 1) 1 0) (ite (= item_5_resp 1) 1 0) (ite (= item_6_resp 1) 1 0) )) (< stop_1_2 7)))
