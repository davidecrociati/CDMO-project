...
(assert (=> (< courier_2_capa courier_1_capa) (< load_2 load_1)))
(assert (= (+(ite (= stop_1_2 1) 1 0) (ite (= stop_1_3 1) 1 0) (ite (= stop_1_4 1) 1 0) (ite (= stop_2_2 1) 1 0) (ite (= stop_2_3 1) 1 0) (ite (= stop_2_4 1) 1 0) ) 1))(assert (= (+(ite (= stop_1_2 2) 1 0) (ite (= stop_1_3 2) 1 0) (ite (= stop_1_4 2) 1 0) (ite (= stop_2_2 2) 1 0) (ite (= stop_2_3 2) 1 0) (ite (= stop_2_4 2) 1 0) ) 1))(assert (= (+(ite (= stop_1_2 3) 1 0) (ite (= stop_1_3 3) 1 0) (ite (= stop_1_4 3) 1 0) (ite (= stop_2_2 3) 1 0) (ite (= stop_2_3 3) 1 0) (ite (= stop_2_4 3) 1 0) ) 1))(assert (=> (<= 1 (+ (ite (= item_1_resp 1) 1 0) (ite (= item_2_resp 1) 1 0) (ite (= item_3_resp 1) 1 0) )) (< stop_1_2 4)))
...
(assert (=> (not (= stop_1_3 4)) (= (select successors stop_1_3) stop_1_4)))
(assert (=> (not (= stop_1_4 4)) (= (select successors stop_1_4) stop_1_5)))
(assert (=> (not (= stop_2_2 4)) (= (select successors stop_2_2) stop_2_3)))
(assert (=> (not (= stop_2_3 4)) (= (select successors stop_2_3) stop_2_4)))
(assert (=> (not (= stop_2_4 4)) (= (select successors stop_2_4) stop_2_5)))
(assert (= distance_1_traveled (+ (ite (and (= item_1_resp 1) (= (select successors 1) 1) ) distance_1_1 0)(ite (and (= item_1_resp 1) (= (select successors 1) 2) ) distance_1_2 0)(ite (and (= item_1_resp 1) (= (select successors 1) 3) ) distance_1_3 0)(ite (and (= item_1_resp 1) (= (select successors 1) 4) ) distance_1_4 0)(ite (and (= item_2_resp 1) (= (select successors 2) 1) ) distance_2_1 0)(ite (and (= item_2_resp 1) (= (select successors 2) 2) ) distance_2_2 0)(ite (and (= item_2_resp 1) (= (select successors 2) 3) ) distance_2_3 0)(ite (and (= item_2_resp 1) (= (select successors 2) 4) ) distance_2_4 0)(ite (and (= item_3_resp 1) (= (select successors 3) 1) ) distance_3_1 0)(ite (and (= item_3_resp 1) (= (select successors 3) 2) ) distance_3_2 0)(ite (and (= item_3_resp 1) (= (select successors 3) 3) ) distance_3_3 0)(ite (and (= item_3_resp 1) (= (select successors 3) 4) ) distance_3_4 0)(ite (= 1 stop_1_2) distance_4_1 0)(ite (= 2 stop_1_2) distance_4_2 0)(ite (= 3 stop_1_2) distance_4_3 0)(ite (= 4 stop_1_2) distance_4_4 0))))
(assert (= distance_2_traveled (+ (ite (and (= item_1_resp 2) (= (select successors 1) 1) ) distance_1_1 0)(ite (and (= item_1_resp 2) (= (select successors 1) 2) ) distance_1_2 0)(ite (and (= item_1_resp 2) (= (select successors 1) 3) ) distance_1_3 0)(ite (and (= item_1_resp 2) (= (select successors 1) 4) ) distance_1_4 0)(ite (and (= item_2_resp 2) (= (select successors 2) 1) ) distance_2_1 0)(ite (and (= item_2_resp 2) (= (select successors 2) 2) ) distance_2_2 0)(ite (and (= item_2_resp 2) (= (select successors 2) 3) ) distance_2_3 0)(ite (and (= item_2_resp 2) (= (select successors 2) 4) ) distance_2_4 0)(ite (and (= item_3_resp 2) (= (select successors 3) 1) ) distance_3_1 0)(ite (and (= item_3_resp 2) (= (select successors 3) 2) ) distance_3_2 0)(ite (and (= item_3_resp 2) (= (select successors 3) 3) ) distance_3_3 0)(ite (and (= item_3_resp 2) (= (select successors 3) 4) ) distance_3_4 0)(ite (= 1 stop_2_2) distance_4_1 0)(ite (= 2 stop_2_2) distance_4_2 0)(ite (= 3 stop_2_2) distance_4_3 0)(ite (= 4 stop_2_2) distance_4_4 0))))
(assert (> distance_1_traveled 0))
