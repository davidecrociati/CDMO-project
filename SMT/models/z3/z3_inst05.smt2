...
(assert (>= stop_2_2 1))
(assert (<= stop_2_2 3))
(assert (=> (> courier_1_capa courier_2_capa) (> load_1 load_2)))(assert (=> (< courier_1_capa courier_2_capa) (< load_1 load_2)))(assert (=> (> courier_2_capa courier_1_capa) (> load_2 load_1)))(assert (=> (< courier_2_capa courier_1_capa) (< load_2 load_1)))(assert (=> (<= 1 (+ (ite (= item_1_resp 1) 1 0) (ite (= item_2_resp 1) 1 0) (ite (= item_3_resp 1) 1 0) )) (< stop_1_2 4)))
