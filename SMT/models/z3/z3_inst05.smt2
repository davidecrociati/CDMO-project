...
(assert (>= stop_2_2 1))
(assert (<= stop_2_2 3))
(assert (=> (> courier_1_capa courier_2_capa) (> load_1 load_2)))(assert (=> (< courier_1_capa courier_2_capa) (< load_1 load_2)))(assert (= (+(ite (= stop_1_2 1) 1 0) (ite (= stop_1_3 1) 1 0) (ite (= stop_1_4 1) 1 0) (ite (= stop_2_2 1) 1 0) (ite (= stop_2_3 1) 1 0) (ite (= stop_2_4 1) 1 0) ) 1))(assert (= (+(ite (= stop_1_2 2) 1 0) (ite (= stop_1_3 2) 1 0) (ite (= stop_1_4 2) 1 0) (ite (= stop_2_2 2) 1 0) (ite (= stop_2_3 2) 1 0) (ite (= stop_2_4 2) 1 0) ) 1))(assert (= (+(ite (= stop_1_2 3) 1 0) (ite (= stop_1_3 3) 1 0) (ite (= stop_1_4 3) 1 0) (ite (= stop_2_2 3) 1 0) (ite (= stop_2_3 3) 1 0) (ite (= stop_2_4 3) 1 0) ) 1))(assert (=> (<= 1 (+ (ite (= item_1_resp 1) 1 0) (ite (= item_2_resp 1) 1 0) (ite (= item_3_resp 1) 1 0) )) (< stop_1_2 4)))
