...
(assert (= (+(ite (= stop_1_1 1) 1 0) (ite (= stop_1_2 1) 1 0) (ite (= stop_1_3 1) 1 0) (ite (= stop_2_1 1) 1 0) (ite (= stop_2_2 1) 1 0) (ite (= stop_2_3 1) 1 0) ) 1))
(assert (= (+(ite (= stop_1_1 2) 1 0) (ite (= stop_1_2 2) 1 0) (ite (= stop_1_3 2) 1 0) (ite (= stop_2_1 2) 1 0) (ite (= stop_2_2 2) 1 0) (ite (= stop_2_3 2) 1 0) ) 1))
(assert (= (+(ite (= stop_1_1 3) 1 0) (ite (= stop_1_2 3) 1 0) (ite (= stop_1_3 3) 1 0) (ite (= stop_2_1 3) 1 0) (ite (= stop_2_2 3) 1 0) (ite (= stop_2_3 3) 1 0) ) 1))
